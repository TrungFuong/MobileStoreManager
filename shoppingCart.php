...
if (!empty($_SESSION['cart'])) {
    $itemsInCart = count(array_unique($_SESSION['cart']));
                            ...
                            <div class="row g-0">
                                <div class="col-lg-8">
                                    <div class="p-5">
                                        ...
                                        <div class="pt-5">
                                            <h6 class="mb-0"><a href="electronic.php" class="text-body"><i class="fas fa-long-arrow-alt-left me-2"></i>Back to shop</a></h6>
                                        </div>
                                    </div>
                                </div>
